                      ...
                      <div class="row">
                        <div class="d-flex justify-content-between p-2 px-3">
                          <div class="d-flex flex-row align-items-center"> <img src="https://i.imgur.com/UXdKE3o.jpg"
                            ...
                            <div class="d-flex flex-column ml-2 px-2"> <span class="fw-semibold">Jeanette Sun</span>
                              <small class="mr-2">20 mins</small> </div>
                      ...
                      <div class="col-md-6">
                        <div class="me-sm-1">
                          ...
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex flex-row icons d-flex align-items-center">
                              <i class="fa fa-thumbs-up" aria-hidden="true"></i>Source: <a href="#">
                                xxxxxxxxxxxxxx......xx </a>
                            </div>

                            <div class="d-flex flex-row muted-color"> <span class="ml-2"> <i
                                  class="fa fa-envelope-open-o" aria-hidden="true"></i>Khiếu nại</span>
                            </div>
                          </div>
                          <hr>
