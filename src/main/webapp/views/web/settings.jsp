...
<body>
  ...
  <script src="<c:url value='/template/web/js/choices.min.js' />"></script>
  <script src="<c:url value='/template/web/js/flatpickr.min.js' />"></script>
    <script src="<c:url value='/template/web/js/functions.js' />"></script>
